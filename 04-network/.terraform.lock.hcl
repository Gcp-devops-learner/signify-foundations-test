...
provider "registry.terraform.io/hashicorp/google" {
  version     = "4.79.0"
  constraints = ">= 2.12.0, >= 3.33.0, >= 3.43.0, >= 3.45.0, >= 3.50.0, >= 3.53.0, >= 3.83.0, ~> 4.5, >= 4.51.0, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "4.79.0"
  constraints = ">= 2.12.0, >= 3.1.0, >= 3.43.0, >= 3.45.0, >= 3.50.0, ~> 4.5, < 5.0.0"
  hashes = [
